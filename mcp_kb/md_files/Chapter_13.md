...
The equilibrium constant for a reaction can be used to predict the behavior of mixtures containing its reactants and/or
...
be related to the K values of the individual reactions. Three basic manipulations are involved in this approach, as described below.
...
for the reaction of hydrogen and iodine reacting to form hydrogen iodide is 50.5 under the given conditions. What are the equilibrium concentrations of $\mathrm{H}_{2}, \mathrm{I}_{2}$, and HI in moles/L?
...
- $Q_{c}=\frac{\left[\mathrm{C}\right]^{x}[\mathrm{D}]^{y}}{[\mathrm{~A}]^{m}[\mathrm{~B}]^{n}} \quad$ for the reaction $m \mathrm{~A}+n \mathrm{~B} \rightleftharpoons x \mathrm{C}+y \mathrm{D}$
...
(f) What will happen to the concentrations of $\mathrm{H}_{2}, \mathrm{CO}$, and $\mathrm{CH}_{3} \mathrm{OH}$ at equilibrium if more catalyst is added?
...
(g) What will happen to the concentrations of $\mathrm{N}_{2}, \mathrm{O}_{2}$, and NO at equilibrium if a catalyst is added?
...
51. A reaction is represented by this equation: $2 \mathrm{~W}(a q) \rightleftharpoons \mathrm{X}(a q)+2 \mathrm{Y}(a q) \quad K_{c}=5 \times 10^{-4}$
(a) Write the mathematical expression for the equilibrium constant.
...
$\mathrm{N}_{2}(g)+3 \mathrm{H}_{2}(g) \rightleftharpoons 2 \mathrm{NH}_{3}(g)$
An equilibrium mixture of $\mathrm{NH}_{3}(g), \mathrm{H}_{2}(g)$, and $\mathrm{N}_{2}(g)$ at $500^{\circ} \mathrm{C}$ was found to contain $1.35 \mathrm{M} \mathrm{H}_{2}, 1.15 \mathrm{M} \mathrm{N}_{2}$, and 4.12 $\times 10^{-1} \mathrm{M} \mathrm{NH}_{3}$.
...
What is the equilibrium constant for the reaction if a mixture at equilibrium contains gases with the following concentrations: $\mathrm{CH}_{4}, 0.126 M ; \mathrm{H}_{2} \mathrm{O}, 0.242 M ; \mathrm{CO}, 0.126 M ; \mathrm{H}_{2} 1.15 M$, at a temperature of $760^{\circ} \mathrm{C}$ ?
54. A 0.72 -mol sample of $\mathrm{PCl}_{5}$ is put into a $1.00-\mathrm{L}$ vessel and heated. At equilibrium, the vessel contains 0.40 mol of $\mathrm{PCl}_{3}(g)$ and 0.40 mol of $\mathrm{Cl}_{2}(g)$. Calculate the value of the equilibrium constant for the decomposition of $\mathrm{PCl}_{5}$ to $\mathrm{PCl}_{3}$ and $\mathrm{Cl}_{2}$ at this temperature.
...
56. Calculate the value of the equilibrium constant $K_{P}$ for the reaction $2 \mathrm{NO}(g)+\mathrm{Cl}_{2}(g) \rightleftharpoons 2 \mathrm{NOCl}(g)$ from these equilibrium pressures: $\mathrm{NO}, 0.050 \mathrm{~atm} ; \mathrm{Cl}_{2}, 0.30 \mathrm{~atm} ; \mathrm{NOCl}, 1.2 \mathrm{~atm}$.
...
60. Complete the changes in concentrations (or pressure, if requested) for each of the following reactions.

(a)

![Image](Chapter_13_images/img-9.jpeg)

(b)

![Image](Chapter_13_images/img-10.jpeg)

(c) Change in pressure:

![Image](Chapter_13_images/img-22.png)

(d) Change in pressure:

![Image](Chapter_13_images/img-23.png)

(e)

![Image](Chapter_13_images/img-24.png)

(f) change in pressure:

![Image](Chapter_13_images/img-25.png)

61. Complete the changes in concentrations (or pressure, if requested) for each of the following reactions.

(a)

![Image](Chapter_13_images/img-11.jpeg)

(b)

![Image](Chapter_13_images/img-12.jpeg)

(c) Change in pressure:

![Image](Chapter_13_images/img-21.png)

(d) Change in pressure:

![Image](Chapter_13_images/img-13.jpeg)

(e)

![Image](Chapter_13_images/img-14.jpeg)

(f) Change in pressure:

![Image](Chapter_13_images/img-20.png)
...
65. Calculate the number of moles of HI that are at equilibrium with 1.25 mol of $\mathrm{H}_{2}$ and 1.25 mol of $\mathrm{I}_{2}$ in a $5.00-\mathrm{L}$ flask at $448^{\circ} \mathrm{C}$.
...
67. What is the pressure of $\mathrm{CO}_{2}$ in a mixture at equilibrium that contains $0.50 \mathrm{~atm} \mathrm{H}_{2}, 2.0 \mathrm{~atm}$ of $\mathrm{H}_{2} \mathrm{O}$, and 1.0 atm of CO at $990^{\circ} \mathrm{C}$ ?
...
$$
\mathrm{CoO}(s)+\mathrm{CO}(g) \rightleftharpoons \mathrm{Co}(s)+\mathrm{CO}_{2}(g) \quad K_{c}=4.90 \times 10^{2} \text { at } 550^{\circ} \mathrm{C}
$$
...
$$
\mathrm{C}(s)+\mathrm{H}_{2} \mathrm{O}(g) \rightleftharpoons \mathrm{CO}(g)+\mathrm{H}_{2}(g) \quad K_{c}=0.2 \text { at } 1000^{\circ} \mathrm{C}
$$
...
$$
\mathrm{Na}_{2} \mathrm{SO}_{4} \cdot 10 \mathrm{H}_{2} \mathrm{O}(s) \rightleftharpoons \mathrm{Na}_{2} \mathrm{SO}_{4}(s)+10 \mathrm{H}_{2} \mathrm{O}(g) \quad K_{P}=4.08 \times 10^{-25} \text { at } 25^{\circ} \mathrm{C}
$$
...
$$
\mathrm{CaCl}_{2} \cdot 6 \mathrm{H}_{2} \mathrm{O}(s) \rightleftharpoons \mathrm{CaCl}_{2}(s)+6 \mathrm{H}_{2} \mathrm{O}(g) \quad K_{P}=5.09 \times 10^{-44} \text { at } 25^{\circ} \mathrm{C}
$$
...
(b) Confirm that the change is small enough to be neglected.
76. Assume that the change in pressure of $\mathrm{H}_{2} \mathrm{~S}$ is small enough to be neglected in the following problem.
(a) Calculate the equilibrium pressures of all species in an equilibrium mixture that results from the decomposition of $\mathrm{H}_{2} \mathrm{~S}$ with an initial pressure of 0.824 atm .
...
$\mathrm{H}_{2} \mathrm{O}(\mathrm{g})+\mathrm{Cl}_{2} \mathrm{O}(\mathrm{g}) \rightleftharpoons 2 \mathrm{HOCl}(\mathrm{g}) \quad K_{c}=0.0900$
78. What are the concentrations of $\mathrm{PCl}_{5}, \mathrm{PCl}_{3}$, and $\mathrm{Cl}_{2}$ in an equilibrium mixture produced by the decomposition of a sample of pure $\mathrm{PCl}_{5}$ with $\left[\mathrm{PCl}_{5}\right]=2.00 \mathrm{M}$ ?
$\mathrm{PCl}_{5}(g) \rightleftharpoons \mathrm{PCl}_{3}(g)+\mathrm{Cl}_{2}(g) \quad K_{c}=0.0211$
79. Calculate the number of grams of HI that are at equilibrium with 1.25 mol of $\mathrm{H}_{2}$ and 63.5 g of iodine at 448 ${ }^{\circ} \mathrm{C}$.
$\mathrm{H}_{2}+\mathrm{I}_{2} \rightleftharpoons 2 \mathrm{HI} \quad K_{c}=50.2$ at $448^{\circ} \mathrm{C}$

80. Butane exists as two isomers, $n$-butane and isobutane.

![Image](Chapter_13_images/img-15.jpeg)
...
81. What is the minimum mass of $\mathrm{CaCO}_{3}$ required to establish equilibrium at a certain temperature in a $6.50-\mathrm{L}$ container if the equilibrium constant $\left(K_{c}\right)$ is 0.50 for the decomposition reaction of $\mathrm{CaCO}_{3}$ at that temperature?
$\mathrm{CaCO}_{3}(s) \rightleftharpoons \mathrm{CaO}(s)+\mathrm{CO}_{2}(g)$
82. The equilibrium constant $\left(K_{c}\right)$ for this reaction is 1.60 at $990^{\circ} \mathrm{C}$ :
...
83. In a $3.0-\mathrm{L}$ vessel, the following equilibrium partial pressures are measured: $\mathrm{N}_{2}, 190$ torr; $\mathrm{H}_{2}, 317$ torr; $\mathrm{NH}_{3}$, $1.00 \times 10^{3}$ torr.
$\mathrm{N}_{2}(g)+3 \mathrm{H}_{2}(g) \rightleftharpoons 2 \mathrm{NH}_{3}(g)$
...
84. The equilibrium constant $\left(K_{c}\right)$ for this reaction is 5.0 at a given temperature.
$\mathrm{CO}(g)+\mathrm{H}_{2} \mathrm{O}(g) \rightleftharpoons \mathrm{CO}_{2}(g)+\mathrm{H}_{2}(g)$
...
87. The binding of oxygen by hemoglobin $(\mathrm{Hb})$, giving oxyhemoglobin $\left(\mathrm{HbO}_{2}\right)$, is partially regulated by the concentration of $\mathrm{H}_{3} \mathrm{O}^{+}$and dissolved $\mathrm{CO}_{2}$ in the blood. Although the equilibrium is complicated, it can be summarized as
