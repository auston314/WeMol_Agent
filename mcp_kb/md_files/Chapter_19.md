...
![Image](Chapter_19_images/img-2.jpeg)
...
![Image](Chapter_19_images/img-3.jpeg)
...
Predict what reaction (if any) will occur between HCl and $\mathrm{Co}(s)$, and between HBr and $\mathrm{Pt}(s)$. You will need to use the standard reduction potentials from Appendix L.
...
![Image](Chapter_19_images/img-12.jpeg)
...
![Image](Chapter_19_images/img-16.jpeg)
...
Figure 19.23 The complex $\left[\mathrm{M}(\mathrm{en})_{3}\right]^{n+}\left(\mathrm{M}^{\mathrm{n+}}=\right.$ a metal ion, en = ethylenediamine) has a nonsuperimposable mirror image.
...
![Image](Chapter_19_images/img-31.png)
...
![Image](Chapter_19_images/img-35.jpeg)
...
![Image](Chapter_19_images/img-38.jpeg)
...
![Image](Chapter_19_images/img-40.jpeg)
...
![Image](Chapter_19_images/img-45.jpeg)
...
Crystal field theory treats interactions between the electrons on the metal and the ligands as a simple electrostatic effect. The presence of the ligands near the metal ion changes the energies of the metal $d$ orbitals relative to their energies in the free ion. Both the color and the magnetic properties of a complex can be attributed to this crystal field splitting. The magnitude of the splitting ( $\Delta_{\text {oct }}$ ) depends on the nature of the ligands bonded to the metal. Strong-field ligands produce large splitting and favor low-spin complexes, in which the $t_{2 g}$ orbitals are completely filled before any electrons occupy the $e_{g}$ orbitals. Weak-field ligands favor formation of high-spin complexes. The $t_{2 g}$ and the $e_{g}$ orbitals are singly occupied before any are doubly occupied.
...
5. Which of the following elements is most likely to be used to prepare La by the reduction of $\mathrm{La}_{2} \mathrm{O}_{3}$ : Al , C , or Fe ? Why?
6. Which of the following is the strongest oxidizing agent: $\mathrm{VO}_{4}{ }^{3}, \quad \mathrm{CrO}_{4}{ }^{2-}$, or $\mathrm{MnO}_{4}{ }^{-}$?
...
(b) $\mathrm{CoO}(s)+\mathrm{O}_{2}(g) \longrightarrow$
...
(b) $\left[\mathrm{Pt}\left(\mathrm{NH}_{3}\right)(\mathrm{py})(\mathrm{Cl})(\mathrm{Br})\right](\mathrm{py}=$ pyridine, $\left.\mathrm{C}_{5} \mathrm{H}_{5} \mathrm{~N}\right)$
...
(b) $\left[\mathrm{Pt}\left(\mathrm{NH}_{3}\right)(\mathrm{py})(\mathrm{Cl})(\mathrm{Br})\right]$ (square planar, py = pyridine, $\left.\mathrm{C}_{5} \mathrm{H}_{5} \mathrm{~N}\right)$
...
35. Draw the geometric, linkage, and ionization isomers for $\left[\mathrm{CoCl}_{5} \mathrm{CN}\right][\mathrm{CN}]$.

#### 19.3 Spectroscopic and Magnetic Properties of Coordination Compounds 

36. Determine the number of unpaired electrons expected for $\left[\mathrm{Fe}\left(\mathrm{NO}_{2}\right)_{6}\right]^{3-}$ and for $\left[\mathrm{FeF}_{6}\right]^{3-}$ in terms of crystal field theory.
...
45. Would you expect the complex $\left[\mathrm{Co}(\mathrm{en})_{3}\right] \mathrm{Cl}_{3}$ to have any unpaired electrons? Any isomers?
