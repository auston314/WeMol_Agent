...
$10^{-13}$, roughly 50 times larger than the value at $25^{\circ} \mathrm{C}$.
...
Answer: $K_{\mathrm{b}}$ for $\mathrm{HPO}_{4}{ }^{2-}=1.6 \times 10^{-7}$
...
![Image](Chapter_14_images/img-17.jpeg)
...
The ammonium ion is the conjugate acid of the weak base ammonia, $\mathrm{NH}_{3}$, and so it will undergo acid ionization (or acid hydrolysis):
...
As indicated by the ionization constants, $\mathrm{H}_{2} \mathrm{CO}_{3}$ is a much stronger acid than $\mathrm{HCO}_{3}{ }^{-}$, so the stepwise ionization reactions may be treated separately.
...
![Image](Chapter_14_images/img-36.png)
...
$$
\begin{gathered}
{\left[\mathrm{H}_{2} \mathrm{CO}_{3}\right]=0.033 M} \\
{\left[\mathrm{H}_{3} \mathrm{O}^{+}\right]=\left[\mathrm{HCO}_{3}^{-}\right]=1.2 \times 10^{-4} M}
\end{gathered}
$$
...
{\left[\mathrm{CO}_{3}{ }^{2-}\right]=\frac{\left(4.7 \times 10^{-11}\right)\left(1.2 \times 10^{-4}\right)}{1.2 \times 10^{-4}}=4.7 \times 10^{-11} M}
\end{gathered}
$$

To summarize: at equilibrium $\left[\mathrm{H}_{2} \mathrm{CO}_{3}\right]=0.033 \mathrm{M} ;\left[\mathrm{H}_{3} \mathrm{O}^{+}\right]=1.2 \times 10^{-4} ;\left[\mathrm{HCO}_{3}{ }^{-}\right]=1.2 \times 10^{-4} \mathrm{M}$; $\left[\mathrm{CO}_{3}{ }^{2-}\right]=5.6 \times 10^{-11} \mathrm{M}$.
...
\text { Answer: }\left[\mathrm{H}_{2} \mathrm{~S}\right]=0.1 \mathrm{M} ;\left[\mathrm{H}_{3} \mathrm{O}^{+}\right]=\left[\mathrm{HS}^{-}\right]=0.000094 \mathrm{M} ;\left[\mathrm{S}^{2-}\right]=1 \times 10^{-19} \mathrm{M}
\end{array}
$$

A triprotic acid is an acid that has three ionizable H atoms. Phosphoric acid is one example:

First ionization: $\mathrm{H}_{3} \mathrm{PO}_{4}(a q)+\mathrm{H}_{2} \mathrm{O}(l) \rightleftharpoons \mathrm{H}_{3} \mathrm{O}^{+}(a q)+\mathrm{H}_{2} \mathrm{PO}_{4}{ }^{-}(a q)$
Second ionization: $\mathrm{H}_{2} \mathrm{PO}_{4}{ }^{-}(a q)+\mathrm{H}_{2} \mathrm{O}(l) \rightleftharpoons \mathrm{H}_{3} \mathrm{O}^{+}(a q)+\mathrm{HPO}_{4}{ }^{2-}(a q)$
Third ionization: $\mathrm{HPO}_{4}{ }^{2-}(a q)+\mathrm{H}_{2} \mathrm{O}(l) \rightleftharpoons \mathrm{H}_{3} \mathrm{O}^{+}(a q)+\mathrm{PO}_{4}{ }^{3-}(a q)$

$$
K_{\mathrm{a} 1}=7.5 \times 10^{-3}
$$

$$
K_{\mathrm{a} 2}=6.2 \times 10^{-8}
$$

$$
K_{\mathrm{a} 3}=4.2 \times 10^{-13}
$$
...
\mathrm{H}_{2} \mathrm{O}(l)+H \mathrm{CO}^{3-}(a q) \rightleftharpoons \mathrm{H}_{2} \mathrm{CO}_{3}(a q)+\mathrm{OH}^{-}(a q) & K_{\mathrm{b} 2}=2.3 \times 10^{-8}
\end{array}
$$
...
![Image](Chapter_14_images/img-37.png)

Substituting the equilibrium concentration terms into the $K_{\mathrm{a}}$ expression, assuming $x<<0.10$, and solving the simplified equation for $x$ yields
...
$$
0.0010 \nLeftarrow \times\left(\frac{0.10 \mathrm{~mol} \mathrm{NaOH}}{1 \mathrm{~L}}\right)=1.0 \times 10^{-4} \mathrm{~mol} \mathrm{NaOH}
$$

The initial molar amount of acetic acid is

$$
0.100 \nLeftarrow \times\left(\frac{0.100 \mathrm{~mol} \mathrm{CH}_{3} \mathrm{CO}_{2} \mathrm{H}}{1 \mathrm{~L}}\right)=1.00 \times 10^{-2} \mathrm{~mol} \mathrm{CH}_{3} \mathrm{CO}_{2} \mathrm{H}
$$
...
$$
\begin{gathered}
{\left[\mathrm{H}_{3} \mathrm{O}^{+}\right]=10^{-4.74}=1.8 \times 10^{-5} \mathrm{M}} \\
\operatorname{mol} \mathrm{H}_{3} \mathrm{O}^{+}=(0.100 \mathrm{~L})\left(1.8 \times 10^{-5} \mathrm{M}\right)=1.8 \times 10^{-6} \mathrm{~mol} \mathrm{H}_{3} \mathrm{O}^{+}
\end{gathered}
$$
...
$$
\operatorname{mol} \mathrm{OH}^{-}=(0.0010 L)(0.10 M)=1.0 \times 10^{-4} \mathrm{~mol} \mathrm{OH}^{-}
$$

The added hydroxide will neutralize hydronium ion via the reaction

$$
\mathrm{H}_{3} \mathrm{O}^{+}(a q)+\mathrm{OH}^{-}(a q) 2 \mathrm{H}_{2} \mathrm{O}(l)
$$
...
$$
9.8 \times 10^{-5} \mathrm{~mol} \mathrm{OH}^{-} / 0.101 L=9.7 \times 10^{-4} \mathrm{M}
$$
...
Answer: Initial pH of $1.8 \times 10^{-5} \mathrm{M} \mathrm{HCl} ; \mathrm{pH}=-\log \left[\mathrm{H}_{3} \mathrm{O}^{+}\right]=-\log \left[1.8 \times 10^{-5}\right]=4.74$
Moles of $\mathrm{H}_{3} \mathrm{O}^{+}$in $100 \mathrm{~mL} 1.8 \times 10^{-5} \mathrm{M} \mathrm{HCl} ; 1.8 \times 10^{-5} \mathrm{~moles} / \mathrm{L} \times 0.100 \mathrm{~L}=1.8 \times 10^{-6}$ Moles of $\mathrm{H}_{3} \mathrm{O}^{+}$added by addition of 1.0 mL of $0.10 \mathrm{M} \mathrm{HCl}: 0.10$ moles $/ \mathrm{L} \times 0.0010 \mathrm{~L}=1.0 \times 10^{-4}$ moles; final pH after addition of 1.0 mL of 0.10 M HCl :
...
![Image](Chapter_14_images/img-22.jpeg)
...
![Image](Chapter_14_images/img-23.jpeg)
...
View information (http://openstaxcollege.org/1/16BufferSystem) on the buffer system encountered in natural waters.
...
$$
\left[\mathrm{H}_{3} \mathrm{O}^{+}\right]=\frac{\mathrm{n}\left(\mathrm{H}^{+}\right)}{V}=\frac{0.002500 \mathrm{~mol} \times\left(\frac{1000 \mathrm{~mL}}{\mathrm{LL}}\right)-0.100 \mathrm{M} \times 12.50 \mathrm{~mL}}{25.00 \mathrm{~mL}+12.50 \mathrm{~mL}}=0.0333 \mathrm{M}
$$
...
{\left[\mathrm{OH}^{-}\right]=\frac{\mathrm{n}\left(\mathrm{OH}^{-}\right)}{V}=\frac{0.100 \mathrm{M} \times 35.70 \mathrm{~mL}-0.002500 \mathrm{~mol} \times\left(\frac{1000 \mathrm{~mL}}{\mathrm{LL}}\right)}{25.00 \mathrm{~mL}+37.50 \mathrm{~mL}}=0.0200 \mathrm{M}}
\end{array}
$$
...
Calculate the pH for the strong acid/strong base titration between 50.0 mL of $0.100 \mathrm{M} \mathrm{HNO}_{3}(a q)$ and 0.200 $M \mathrm{NaOH}$ (titrant) at the listed volumes of added base: $0.00 \mathrm{~mL}, 15.0 \mathrm{~mL}, 25.0 \mathrm{~mL}$, and 40.0 mL .
...
Consider the titration of 25.00 mL of $0.100 \mathrm{M} \mathrm{CH}_{3} \mathrm{CO}_{2} \mathrm{H}$ with 0.100 M NaOH . The reaction can be represented as:
...
$$
\begin{gathered}
K_{\mathrm{a}}=\frac{\left[\mathrm{H}_{3} \mathrm{O}^{+}\right]\left[\mathrm{CH}_{3} \mathrm{CO}_{2}^{-}\right]}{\left[\mathrm{CH}_{3} \mathrm{CO}_{2} \mathrm{H}\right]} \approx \frac{\left[\mathrm{H}_{3} \mathrm{O}^{+}\right]^{2}}{\left[\mathrm{CH}_{3} \mathrm{CO}_{2} \mathrm{H}\right]_{0}} \\
...
\mathrm{pH}=-\log \left(1.3 \times 10^{-3}\right)=2.87
\end{gathered}
$$
...
Assuming $x<<0.0500$, the pH may be calculated via the usual ICE approach: $K_{\mathrm{b}}=\frac{x^{2}}{0.0500 M}$
...
Calculate the pH for the weak acid/strong base titration between 50.0 mL of $0.100 M \mathrm{HCOOH}(a q)$ (formic acid) and $0.200 M \mathrm{NaOH}$ (titrant) at the listed volumes of added base: $0.00 \mathrm{~mL}, 15.0 \mathrm{~mL}, 25.0 \mathrm{~mL}$, and 30.0 mL .

Answer: 0.00 mL: 2.37; 15.0 mL: 3.92; 25.00 mL: 8.29; 30.0 mL: 12.097
Performing additional calculations similar to those in the preceding example permits a more full assessment of titration curves. A summary of $\mathrm{pH} /$ volume data pairs for the strong and weak acid titrations is provided in Table

14.2 and plotted as titration curves in Figure 14.18. A comparison of these two curves illustrates several important concepts that are best addressed by identifying the four stages of a titration:
...
pre-equivalence point ( $0 \mathrm{~mL}<V<25 \mathrm{~mL}$ ): solution pH increases gradually and the acid is consumed by reaction with added titrant; composition includes unreacted acid and the reaction product, its conjugate base
equivalence point $(V=25 \mathrm{~mL})$ : a drastic rise in pH is observed as the solution composition transitions from acidic to either neutral (for the strong acid sample) or basic (for the weak acid sample), with pH determined by ionization of the conjugate base of the acid
...
Table 14.2 **pH Values in the Titrations of a Strong Acid and of a Weak Acid**

| Volume of 0.100 M NaOH <br> Added (mL) | Moles of NaOH <br> Added | pH Values 0.100 M <br> $\mathrm{HCl}^{(1)}$ | pH Values 0.100 M <br> $\mathrm{CH}_{3} \mathrm{CO}_{2} \mathrm{H}^{(1)}$ |
| :--: | :--: | :--: | :--: |
| 0.0 | 0.0 | 1.00 | 2.87 |
...
1. Titration of 25.00 mL of $0.100 \mathrm{M} \mathrm{HCl}(0.00250 \mathrm{~mol}$ of HCl$)$ with $0.100 \mathrm{M} \mathrm{NaOH}$.
2. Titration of 25.00 mL of $0.100 \mathrm{M} \mathrm{CH}_{3} \mathrm{CO}_{2} \mathrm{H}\left(0.00250 \mathrm{~mol}\right.$ of $\left.\mathrm{CH}_{3} \mathrm{CO}_{2} \mathrm{H}\right)$ with $0.100 \mathrm{M} \mathrm{NaOH}$.

![Image](Chapter_14_images/img-24.jpeg)
...
$$
\begin{gathered}
\frac{\mathrm{HIn}(a q)+\mathrm{H}_{2} \mathrm{O}(l) \rightleftharpoons \mathrm{H}_{3} \mathrm{O}^{+}(a q)+\mathrm{In}^{-}(a q)}{\text {red }} \\
K_{a}=\frac{\left[\mathrm{H}_{3} \mathrm{O}^{+}\right]\left[\mathrm{In}^{-}\right]}{[\mathrm{HIn}]}=4.0 \times 10^{-4}
\end{gathered}
$$
...
The perceived color of an indicator solution is determined by the ratio of the concentrations of the two species $\mathrm{In}^{-}$and HIn . If most of the indicator (typically about $60-90 \%$ or more) is present as $\mathrm{In}^{-}$, the perceived color of the solution is yellow. If most is present as HIn, then the solution color appears red. The Henderson-Hasselbalch equation is useful for understanding the relationship between the pH of an indicator solution and its composition (thus, perceived color):

$$
\mathrm{pH}=\mathrm{p} K \mathrm{a}+\log \left(\frac{[\mathrm{In}_{\mathrm{n}}^{-1}}{[\mathrm{HIn}]}\right)
$$
...
**acidic**  
a solution in which $[\text{H}_3\text{O}^+] > [\text{OH}^-]$
...
**neutral**  
describes a solution in which $[\text{H}_3\text{O}^+] = [\text{OH}^-]$
...
(a) 0.200 M HCl
(b) 0.0143 M NaOH
(c) $3.0 \mathrm{MHNO}_{3}$
(d) $0.0031 \mathrm{MCa}(\mathrm{OH})_{2}$
...
25. The hydroxide ion concentration in household ammonia is $3.2 \times 10^{-3} M$ at $25^{\circ} \mathrm{C}$. What is the concentration of hydronium ions in the solution?
...
(b) List those compounds in (a) that can behave as Brønsted-Lowry acids with strengths lying between those of $\mathrm{H}_{2} \mathrm{O}^{+}$and $\mathrm{H}_{2} \mathrm{O}$.
(c) List those compounds in (a) that can behave as Brønsted-Lowry bases with strengths lying between those of $\mathrm{H}_{2} \mathrm{O}$ and $\mathrm{OH}^{-}$.
...
39. Which is the stronger base, $\left(\mathrm{CH}_{3}\right)_{3} \mathrm{~N}$ or $\mathrm{H}_{2} \mathrm{BO}_{3}{ }^{-}$?
...
(b) basicity: $\mathrm{BrO}_{2}{ }^{-}, \quad \mathrm{ClO}_{2}{ }^{-}, \quad \mathrm{IO}_{2}{ }^{-}$
...
(f) basicity: $\mathrm{BrO}^{-}, \mathrm{BrO}_{2}{ }^{-}, \quad \mathrm{BrO}_{3}{ }^{-}, \quad \mathrm{BrO}_{4}{ }^{-}$
...
(d) KOH
(e) HF
52. Why is the hydronium ion concentration in a solution that is 0.10 M in HCl and 0.10 M in HCOOH determined by the concentration of HCl ?
...
$[H C l O]=2.38 \times 10^{-4} \mathrm{M} ;$
...
55. Determine $K_{\mathrm{b}}$ for the nitrite ion, $\mathrm{NO}_{2}{ }^{-}$. In a $0.10-\mathrm{M}$ solution this base is $0.0015 \%$ ionized.
56. Determine $K_{\mathrm{a}}$ for hydrogen sulfate ion, $\mathrm{HSO}_{4}{ }^{-}$. In a $0.10-\mathrm{M}$ solution the acid is $29 \%$ ionized.
...
(a) $0.0092 M \mathrm{HClO}$, a weak acid
(b) $0.0784 M \mathrm{C}_{6} \mathrm{H}_{5} \mathrm{NH}_{2}$, a weak base
(c) 0.0810 M HCN , a weak acid
(d) $0.11 M\left(\mathrm{CH}_{3}\right)_{3} \mathrm{~N}$, a weak base
(e) $0.120 M \mathrm{Fe}\left(\mathrm{H}_{2} \mathrm{O}\right)_{6}{ }^{2+}$ a weak acid, $K_{\mathrm{a}}=1.6 \times 10^{-7}$
61. Propionic acid, $\mathrm{C}_{2} \mathrm{H}_{5} \mathrm{CO}_{2} \mathrm{H}\left(\mathrm{K}_{\mathrm{a}}=1.34 \times 10^{-5}\right)$, is used in the manufacture of calcium propionate, a food preservative. What is the pH of a $0.698-M$ solution of $\mathrm{C}_{2} \mathrm{H}_{5} \mathrm{CO}_{2} \mathrm{H}$ ?
...
64. Nicotine, $\mathrm{C}_{10} \mathrm{H}_{14} \mathrm{~N}_{2}$, is a base that will accept two protons $\left(K_{\mathrm{b} 1}=7 \times 10^{-7}, K_{\mathrm{b} 2}=1.4 \times 10^{-11}\right)$. What is the concentration of each species present in a $0.050-M$ solution of nicotine?
...
74. Calculate the concentration of each species present in a $0.010-\mathrm{M}$ solution of phthalic acid, $\mathrm{C}_{6} \mathrm{H}_{4}\left(\mathrm{CO}_{2} \mathrm{H}\right)_{2}$.
...
80. What is $\left[\mathrm{H}_{3} \mathrm{O}^{+}\right]$in a solution of $0.25 M \mathrm{CH}_{3} \mathrm{CO}_{2} \mathrm{H}$ and $0.030 M \mathrm{NaCH}_{3} \mathrm{CO}_{2}$ ?
$\mathrm{CH}_{3} \mathrm{CO}_{2} \mathrm{H}(a q)+\mathrm{H}_{2} \mathrm{O}(l) \rightleftharpoons \mathrm{H}_{3} \mathrm{O}^{+}(a q)+\mathrm{CH}_{3} \mathrm{CO}_{2}{ }^{-}(a q) \quad K_{\mathrm{a}}=1.8 \times 10^{-5}$
81. What is $\left[\mathrm{H}_{3} \mathrm{O}^{+}\right]$in a solution of $0.075 M \mathrm{HNO}_{2}$ and $0.030 M \mathrm{NaNO}_{2}$ ?
...
82. What is $\left[\mathrm{OH}^{-}\right]$in a solution of $0.125 M \mathrm{CH}_{3} \mathrm{NH}_{2}$ and $0.130 M \mathrm{CH}_{3} \mathrm{NH}_{3} \mathrm{Cl}$ ?
...
83. What is $\left[\mathrm{OH}^{-}\right]$in a solution of $1.25 M \mathrm{NH}_{3}$ and $0.78 M \mathrm{NH}_{4} \mathrm{NO}_{3}$ ?
...
88. How much solid $\mathrm{NaCH}_{3} \mathrm{CO}_{2} \cdot 3 \mathrm{H}_{2} \mathrm{O}$ must be added to 0.300 L of a $0.50-\mathrm{M}$ acetic acid solution to give a buffer with a pH of 5.00 ? (Hint: Assume a negligible change in volume as the solid is added.)
...
94. Calculate the pH at the following points in a titration of $40 \mathrm{~mL}(0.040 \mathrm{~L})$ of 0.100 M barbituric acid ( $K_{\mathrm{a}}=9.8$ $\times 10^{-5}$ ) with 0.100 M KOH .
(a) no KOH added
